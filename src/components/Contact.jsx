const LINKS = [
  {
    label: 'Email',
    value: 'christina.v.huynh1@gmail.com',
  ...
  {
    label: 'LinkedIn',
    value: 'linkedin.com/in/chrisvh7',
      ...
      <div className="max-w-3xl mx-auto text-center">
          ...
          {LINKS.map(link => (
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className="font-body text-white/60 group-hover:text-white/80 text-xs transition-colors">
                  {link.value}
                </p>
              </div>
            </a>
        ...
        <div className="border-t border-white/[0.05] pt-10">
          <p className="font-mono text-[10px] tracking-widest uppercase text-white/20">
            Christina Huynh · Built with React + Vite + Tailwind CSS
          </p>
          <p className="font-mono text-[9px] text-white/10 mt-1">
            Designed & developed by Christina Huynh
          </p>
        </div>
      </div>
    </section>
