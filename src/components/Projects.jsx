const PROJECTS = [
  {
    title: 'NASA Data Lakehouse: NEO Pipeline',
    type: 'Personal',
    tags: ['Python', 'DuckDB', 'Parquet', 'FastAPI', 'Claude API', 'NASA', 'Data Engineering'],
    href: 'https://github.com/cvhuynh1777/nasa-data-lakehouse',
    color: 'cyan',
    icon: '◈',
    desc: 'End-to-end medallion architecture pipeline ingesting NASA Near Earth Object data through bronze, silver, and gold layers, enriched with a composite hazard scoring model and a natural language text-to-SQL query interface powered by Claude.',
  },
  {
